...
const CardapioPage = () => {
  ...
  return (
    <div>
      ...
      <ul
        className="flex flex-wrap justify-center items-center gap-20 p-4 m-20 mt-10"
        id="games"
      >
        {produto.map((item) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center justify-center">
                <button className="bg-green-500 p-3 mt-2 rounded-2xl hover:bg-green-700">Comprar</button>
              </div>
            </li>
          );
        })}
